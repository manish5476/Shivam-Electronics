import { Component, OnInit, ChangeDetectionStrategy, ChangeDetectorRef, inject, TemplateRef } from '@angular/core';
...
// Define the layout option interface for the new switcher
...
export class AdminDashboardComponent implements OnInit {
  ...
  startDate?: string;
  endDate?: string;
  // NEW: Properties for Layout Switching
  layoutMode: 'grid' | 'tabs' = 'grid'; // Default to grid view
  ...
  ngOnInit() {
     // NEW: Initialize layout options
    this.layoutOptions = [
      { icon: 'pi pi-th-large', value: 'grid', tooltip: 'Grid View' },
      { icon: 'pi pi-table', value: 'tabs', tooltip: 'Tab View' }
    ];
  ...
  // --- Dialog handling ---
  openDialog(title: string, data: any, template?: TemplateRef<any>) {
    this.selectedTitle = title;
    this.selectedData = data;
    this.dialogTemplate = template; // optional HTML template
