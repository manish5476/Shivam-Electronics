...
export class MasterListManagerComponent implements OnInit {
    ...
    this.masterListService.createType(this.createForm.value).subscribe({
      next: () => {
        this.messageService.add({
          severity: 'success',
          summary: 'Success',
          detail: 'Master Type created successfully',
        });
      ...
      error: (err) =>
        this.messageService.add({
          severity: 'error',
          summary: 'Error',
          detail: err.message || 'Could not create type',
        }),
    });
  }
  ...
  deleteType() {
    ...
    this.confirmationService.confirm({
      message:
        'Are you sure you want to delete this entire type and all its items?',
        ...
        this.masterListService.deleteType(this.selectedType!).subscribe({
          ...
          error: (err) =>
            this.messageService.add({
              severity: 'error',
              summary: 'Error',
              detail: err.message || 'Could not delete type',
            }),
        });
      },
    });
  ...
  addItem() {
    ...
    this.masterListService.addItem(this.selectedType!, this.newItem).subscribe({
      next: (res: any) => {
        ...
        this.newItem = { label: '', value: '' }; // Reset with correct properties
        this.messageService.add({
          severity: 'success',
          summary: 'Success',
      ...
      error: (err) =>
        this.messageService.add({
          severity: 'error',
          summary: 'Error',
          detail: err.message || 'Could not add item',
        }),
    });
  }
      ...
      .subscribe({
        ...
        error: (err) => {
          ...
          this.onRowEditCancel(
            item,
            this.items.findIndex((i) => i._id === item._id),
          );
        },
      });
  }
  ...
  deleteItem(item: any) {
    this.confirmationService.confirm({
      message: `Are you sure you want to delete the item "${item.label}"?`, // UPDATED to use label
      header: 'Delete Confirmation',
          ...
          .subscribe({
            ...
            error: (err) =>
              this.messageService.add({
                severity: 'error',
                summary: 'Error',
                detail: err.message || 'Could not delete item',
              }),
          });
      },
    });
